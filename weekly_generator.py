...
1. 不要突然写出一个读者无法理解的状态，例如：“他给我上了药”“屁股还疼着”。

2. 如果你认为这种状态不重要，就不要记录。

3. 如果你认为这种状态值得记录，就必须从全部来源日记中找到并写清与它直接相关的前因后果：为什么需要上药、为什么会疼、遇到了什么问题、使用了什么办法、最后解决了什么。
...
6. 来源日记中明确记录的私密亲密经历，是凛祢与用户关系的一部分，不要仅仅因为它们私密就删除。日记中出现了私密的亲密片段和打屁股的情节时应当在周记中体现，尤其是当某个亲密片段比较不同寻常（比如比较激烈）或其对理解两人的关系、感受或当日事件有意义，可以保留具有代表性的内容或当时具体的话语，并写清必要的前因后果。
