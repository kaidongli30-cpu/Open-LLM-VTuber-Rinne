...
6. 来源日记中明确记录的重要人际互动，是共同经历与关系记忆的一部分，不要无故全部删除。可以保留具有代表性的内容或当时具体的话语，并写清必要的前因后果。

7. 关系内容同样必须严格依据来源，不得扩写动作、感受或后续，不得为了增强戏剧性而脑补细节。无需逐句复述全部互动过程，应保留其记忆意义、关系意义和真实感受。
